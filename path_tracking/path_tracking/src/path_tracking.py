...
class PathTracking():
    def __init__(self):
        ...
        self.path_sub = rospy.Subscriber("/local_path", Path, self.callback_path_tracking) # 지역 경로
        self.speed_sub = rospy.Subscriber("/ublox_gps/fix_velocity", TwistWithCovarianceStamped, self.callback_speed) # 차량 현재 속도
    ...
    def callback_path_tracking(self, path_msg):
